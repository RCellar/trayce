...
Run: `/home/dmickles/.bun/bin/bun build client/pricing.ts --outdir /tmp/trayce-check --target browser 2>&1`
...
Run: `/home/dmickles/.bun/bin/bun test tests/server/usage.test.ts`
...
Run: `/home/dmickles/.bun/bin/bun test tests/bridge/transcript-watcher.test.ts`
...
Run: `timeout 3 /home/dmickles/.bun/bin/bun run bridge/index.ts 2>&1 || true`
...
Run: `/home/dmickles/.bun/bin/bun test tests/server/websocket.test.ts`
...
Run: `/home/dmickles/.bun/bin/bun test tests/server/ tests/bridge/`
...
Run: `/home/dmickles/.bun/bin/bun build client/app.ts --outdir /tmp/trayce-check --target browser 2>&1`
...
Run: `/home/dmickles/.bun/bin/bun build client/app.ts --outdir dist/client --minify --target browser && cp client/index.html client/style.css dist/client/`
Expected: Build succeeds.
...
Run: `/home/dmickles/.bun/bin/bun test tests/server/ tests/bridge/ tests/client/`
Expected: All pass (except pre-existing integration test PATH issue).
...
sleep 1
nohup /home/dmickles/.bun/bin/bun run server/index.ts > /tmp/trayce/server.log 2>&1 &
sleep 2
