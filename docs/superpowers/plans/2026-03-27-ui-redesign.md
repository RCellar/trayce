...
Run: `/home/dmickles/.bun/bin/bun build client/theme.ts --outdir /tmp/trayce-check --target browser 2>&1`
Expected: Build succeeds.
...
Run: `/home/dmickles/.bun/bin/bun build client/floating-panel.ts --outdir /tmp/trayce-check --target browser 2>&1`
Expected: Build succeeds.
...
Run: `/home/dmickles/.bun/bin/bun test`
