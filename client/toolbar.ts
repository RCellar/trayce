...
const ICONS: Record<string, string> = {
  ...
  marker: svg('<path d="M5 13l-1.5 3.5L7 15l7-7-3-3-6 6z"/><path d="M11 5l3 3"/><path d="M13 3l2 2"/>'),
  // Watercolor — droplet
  watercolor: svg('<path d="M9 2.5C9 2.5 4 8 4 11.5a5 5 0 0010 0C14 8 9 2.5 9 2.5z"/>'),
  // Highlighter — wide angled stroke
  highlighter: svg('<path d="M4 10l4-7h2l4 7"/><path d="M3.5 10h11" stroke-width="3" opacity="0.5"/><path d="M5 13h8"/>'),
  // Eraser — rectangular eraser
  eraser: svg('<path d="M6 15l-3.5-3.5a2 2 0 010-2.8L9.2 2l6.3 6.3a2 2 0 010 2.8L13 13.5"/><path d="M4.5 15h11"/>'),
  // Image — picture frame with mountain
  image: svg('<rect x="2.5" y="3.5" width="13" height="11" rx="1.5"/><path d="M2.5 12l3.5-3.5 2.5 2.5 3-3.5 4 4.5"/><circle cx="6" cy="7" r="1.2"/>'),
  // Clear — trash can
  clear: svg('<path d="M4.5 5.5v9a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5v-9"/><path d="M3 5.5h12"/><path d="M7 5.5V3.5a1 1 0 011-1h2a1 1 0 011 1v2"/>'),
  // Panel: brush/layers — sliders
  sliders: svg('<circle cx="5" cy="5.5" r="1.5"/><path d="M6.5 5.5H16"/><path d="M2 5.5h1.5"/><circle cx="11" cy="9.5" r="1.5"/><path d="M2 9.5h8"/><path d="M12.5 9.5H16"/><circle cx="7" cy="13.5" r="1.5"/><path d="M8.5 13.5H16"/><path d="M2 13.5h3.5"/>'),
  // Panel: response — speech bubble
  chat: svg('<path d="M3 3h12a1 1 0 011 1v7a1 1 0 01-1 1H8l-3 3v-3H3a1 1 0 01-1-1V4a1 1 0 011-1z"/>'),
  // Panel: transcript — document lines
  transcript: svg('<rect x="3" y="2" width="12" height="14" rx="1.5"/><path d="M6 5.5h6"/><path d="M6 8.5h6"/><path d="M6 11.5h4"/>'),
  // Panel: usage — bar chart
  chart: svg('<path d="M3 15V7"/><path d="M7 15V4"/><path d="M11 15V9"/><path d="M15 15V6"/>' , false),
};
